...
const styles = StyleSheet.create({
  ...
  currentBadge: { fontSize: 10, color: '#38bdf8', fontWeight: '900', backgroundColor: '#0ea5e930', paddingHorizontal: 8, paddingVertical: 3, borderRadius: 0 },
  closeBtn: { margin: 16, backgroundColor: '#1e293b', borderRadius: 0, paddingVertical: 12, alignItems: 'center' },
